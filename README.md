...
In summary the main idea is to aim to produce clean coding procedures and reproducible Matlab Scripts. This can be helpful when reviewing your code in order to identify bugs. Furthermore, this can be extremely helpful when colloborating on projects.  
